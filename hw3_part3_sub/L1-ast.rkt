...
;; Type: [Symbol -> var-lazy-decl]
(define make-var-lazy-decl
  (lambda (var) (list 'var-lazy-decl var)))
...
(define var-lazy-decl->tag
  (lambda (var-lazy-decl) (first var-lazy-decl)))

;; Type: [Symbol*lit-exp -> var-lazy-decl]
(define make-var-decl-tag 
(lambda (var tag)
   (if (eq? tag 'var-lazy-decl)
        (list 'var-lazy-decl var )
        (list 'var-decl var))))
